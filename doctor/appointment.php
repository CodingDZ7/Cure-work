                                ...
                                for ( $x=0; $x<$result->num_rows;$x++){
                                    ...
                                    echo '<tr >
                                        ...
                                        <td style="text-align:center;;">
                                            '.substr($scheduledate,0,10).' à '.substr($scheduletime,0,5).'
                                        </td>
        ...
        if($action=='add-session'){
                    ...
                    <center>
                        ...
                        <tr>
                            ...
                            <tr>
                                ...
                                <td class="label-td" colspan="2">
                                    <label for="docid" class="form-label">Sélectionnez le médecin: </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
                        ...
                        echo     '       </select><br><br>
                            ...
                            <tr>
                                <td class="label-td" colspan="2">
                                    <label for="time" class="form-label">Horaire du programme : </label>
                                </td>
                            </tr>
                            <tr>
                                <td class="label-td" colspan="2">
            ...
            <div id="popup1" class="overlay">
                    ...
                    <br><br>
                        ...
                        <a href="schedule.php" class="non-style-link"><button  class="btn-primary btn"  style="display: flex;justify-content: center;align-items: center;margin:10px;padding:10px;"><font class="tn-in-text">&nbsp;&nbsp;Accepter&nbsp;&nbsp;</font></button></a>
                        <br><br><br><br>
                        </div>
                    </center>
            </div>
