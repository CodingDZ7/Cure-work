    ...
    <div class="container">
        ...
        <div class="dash-body" style="margin-top: 15px">
            <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;">
                    ...
                    <td>
                        <p style="font-size: 23px;padding-left:50px;font-weight: 600;">Paramètres</p>
                    ...
                    <td colspan="4">
                        ...
                        <table class="filter-container" style="border: none;" border="0">
                            ...
                            <td style="width: 100%;">
                                    ...
                                    <div  class="dashboard-items setting-tabs"  style="padding:20px;margin:auto;width:100%;display: flex;">
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <table width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                            ...
                            <tr>
                                <td colspan="2">
                                    <a href="settings.php"><input type="button" value="Accepter" class="login-btn btn-primary-soft btn" ></a>
                            ...
                            <center>
                                ...
                                <tr>
                                    ...
                                    <tr>
                                        ...
                                        ID de l\'utilisateur : '.$id.' (Généré automatiquement)<br><br>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="label-td" colspan="2">
            ...
            echo '
                <div id="popup1" class="overlay">
                        ...
                        <br><br><br><br>
                            ...
                            <a class="close" href="settings.php">&times;</a>
                            <div class="content">
                                Si vous changez également votre e-mail, veuillez vous déconnecter et vous reconnecter avec votre nouvelle adresse e-mail.
