...
if($_POST){
    ...
    if ($newpassword==$cpassword){
        ...
        if($result->num_rows==1){
            $error='<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Vous avez déjà un compte pour cette adresse e-mail.</label>';
        }else{
            //TODO
        ...
        $error='<label for="promter" class="form-label" style="color:rgb(255, 62, 62);text-align:center;">Erreur de confirmation du mot de passe ! Reconfirmer le mot de passe</label>';
    }
        ...
        <table border="0" style="width: 69%;">
            <tr>
                <td colspan="2">
                    ...
                    <p class="sub-text">C'est bon, ne créez pas de compte utilisateur.</p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td class="label-td" colspan="2">
                    <input type="password" name="cpassword" class="input-text" placeholder="Confirmation du mot de passe" required>
                </td>
            </tr>
